package guru.bonacci.timesup.homeward.streams;
...
import guru.bonacci.timesup.homeward.streams.HomewardBoundTopology;
...
public class TraceProducer {
	...
	void send() {
		for (int i=0; i<10; i++) {
			...
			producer.send(new ProducerRecord<>(HomewardBoundTopology.TRACE_TOPIC, key, record), new Callback() {
				@Override
